...
RESOURCES += src/qt/viridi.qrc src/qt/xdna_locale.qrc

TRANSLATIONS += src/qt/locale/xdna_bg.ts \
                src/qt/locale/xdna_de.ts \
                src/qt/locale/xdna_en.ts \
                src/qt/locale/xdna_es.ts \
                src/qt/locale/xdna_fi.ts \
                src/qt/locale/xdna_fr.ts \
                src/qt/locale/xdna_it.ts \
                src/qt/locale/xdna_ja.ts \
                src/qt/locale/xdna_pl.ts \
                src/qt/locale/xdna_pt.ts \
                src/qt/locale/xdna_ru.ts \
                src/qt/locale/xdna_sk.ts \
                src/qt/locale/xdna_sv.ts \
                src/qt/locale/xdna_vi.ts \
                src/qt/locale/xdna_zh_CN.ts \
                src/qt/locale/xdna_zh_TW.ts
