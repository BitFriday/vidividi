...
#   c) node1 mines 32 blocks, so now node 0 has 60001xdna, node 1 has 4250xdna, node2 has none.
#   d) node0 sends 601 viridi to node2, in two transactions (301 viridi, then 300 viridi).
