...
confused with overall VIRIDI Network Protocol consensus changes.
...
Patches that change VIRIDI consensus rules are considerably more involved than
...
Where a patch set proposes to change the VIRIDI consensus, it must have been
