...
Note
---------------------
Always use absolute paths to configure and compile viridi and the dependencies,
...
memory available when compiling VIRIDI Core. With 512MB of memory or less
...
# Pick some path to install BDB to, here we create a directory within the viridi directory
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, viridi should be built with a non-executable stack
