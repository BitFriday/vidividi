...
Note
---------------------
Always use absolute paths to configure and compile xdna and the dependencies,
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, xdna should be built with a non-executable stack
