TOR SUPPORT IN VIRIDI
=======================

It is possible to run VIRIDI as a Tor hidden service, and connect to such services.
...
Run VIRIDI behind a Tor proxy
----------------------------------

The first step is running VIRIDI behind a Tor proxy. This will already make all
...
```
-externalip=X   You can tell viridi about its publicly reachable address using
