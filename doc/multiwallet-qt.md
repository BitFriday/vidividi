...
In order to support loading of multiple wallets in viridi-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is xdna.cpp.
...
Changes to xdna.cpp
----------------------
xdna.cpp is the entry point into viridi-qt, and as such, will require some minor modifications to provide hooks for
