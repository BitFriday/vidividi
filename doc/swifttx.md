...
* WebSocket: [https://github.com/XDNA-Core/insight-api-xdna#web-socket-api](https://github.com/XDNA-Core/insight-api-xdna#web-socket-api)
* API: [https://github.com/XDNA-Core/insight-api-xdna#swifttx-transactions](https://github.com/XDNA-Core/insight-api-xdna#swifttx-transactions)
